...
public:
	vector_ptr(size_t n=10):__ivector(n){assert("vector_ptr需要一个指针类型" && (T)0  == (void*)0 );}
	vector_ptr(size_t n, const T & val):__ivector(n,val){assert("vector_ptr需要一个指针类型" && (T)0 == (void*)0 );}
