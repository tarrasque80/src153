...
public:
	...
	unsigned int GetFlags() { return m_dwFlags; }
	...
	void Render(A3DFlatCollector* pFC, bool bRenderV=false, CFace* pSpecialFace=NULL, unsigned int dwVColor=0xffff0000, unsigned int dwFColor=0xa0ffff00, const A3DVECTOR3& vRayDir=A3DVECTOR3(1.0f,1.0f,1.0f), const A3DMATRIX4* pTransMatrix=NULL)const;
