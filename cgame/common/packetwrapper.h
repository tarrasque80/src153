...
public:
	...
	packet_raw_wrapper & operator<<(long val)				{push_byte(val);return *this;} 
	packet_raw_wrapper & operator<<(unsigned long val)		{push_byte(val);return *this;} 
	packet_raw_wrapper & operator<<(long long val)			{push_byte(val);return *this;} 
	packet_raw_wrapper & operator<<(unsigned long long val)	{push_byte(val);return *this;} 
...
public:
	...
	packet_baked_wrapper & operator<<(long val)					{push_type((char)T_LONG);push_byte(val);return *this;}
	packet_baked_wrapper & operator<<(unsigned long val) 		{push_type((char)T_UNSIGNED_LONG);push_byte(val);return *this;} 
	packet_baked_wrapper & operator<<(long long val)			{push_type((char)T_LONG64);push_byte(val);return *this;}
	packet_baked_wrapper & operator<<(unsigned long long val)	{push_type((char)T_UNSIGNED_LONG64);push_byte(val);return *this;} 	
...
public:
	...
	packet_in_wrapper & operator>>(long &val)		 		{pop_byte(val);return *this;}
	packet_in_wrapper & operator>>(unsigned long &val)		{pop_byte(val);return *this;}
	packet_in_wrapper & operator>>(long long &val)		 	{pop_byte(val);return *this;}
	packet_in_wrapper & operator>>(unsigned long long &val)	{pop_byte(val);return *this;}	
...
public:
	...
	raw_wrapper & operator<<(long val)				{push_byte(val);return *this;} 
	raw_wrapper & operator<<(unsigned long val)		{push_byte(val);return *this;}
	raw_wrapper & operator<<(long long val)			{push_byte(val);return *this;} 
	raw_wrapper & operator<<(unsigned long long val){push_byte(val);return *this;}
	...
	raw_wrapper & operator>>(long &val)					{ pop_byte(val);return *this; } 
	raw_wrapper & operator>>(unsigned long &val)		{ pop_byte(val);return *this; } 
	raw_wrapper & operator>>(long long &val)			{ pop_byte(val);return *this; } 
	raw_wrapper & operator>>(unsigned long long &val)	{ pop_byte(val);return *this; } 	
