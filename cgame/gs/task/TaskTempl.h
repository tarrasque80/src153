...
{
	unsigned int	m_ulMonsterTemplId;		//  怪物ID
...
struct AWARD_DATA
{
	...
	unsigned int		m_ulRealmExp; // 境界经验
	...
	unsigned int		m_ulStorehouseSize4;	// 账号仓库
...
//////////////////////////////////////////////////// PQ任务奖励 start
	...
	unsigned int		m_ulSpecifyContribTaskID;	// 指定任务贡献度的任务id
	unsigned int		m_ulSpecifyContribSubTaskID; // 指定任务贡献度的子任务ID
	unsigned int		m_ulSpecifyContrib;			// 指定任务贡献度
	
	// 仅PQ子任务专用
	unsigned int		m_ulContrib;		// 贡献度
	unsigned int		m_ulRandContrib;	// 随机贡献度
	unsigned int		m_ulLowestcontrib;	// 最低贡献度
...
//////////////////////////////////////////////////// PQ任务奖励 end
	...
	int                *m_plChangeKey; //[TASK_AWARD_MAX_CHANGE_VALUE]
	int                *m_plChangeKeyValue;
	bool                *m_pbChangeType;
	// 修改历史进度
	unsigned int		m_ulHistoryChangeCnt;
	int				*m_plHistoryChangeKey; //[TASK_AWARD_MAX_CHANGE_VALUE]
	...
	int                *m_plDisplayKey; //[TASK_AWARD_MAX_DISPLAY_VALUE]
...
//	unsigned int	m_ulAbsFailTime;
	...
	unsigned int 	m_ulInventorySlotNum; // 所需包裹空位个数
...
/////////////////////////////////////////////// Account Task start
	...
	unsigned int   m_ulPremise_Task_Least_Num;//多个前提任务需要完成若干个
	// 达到特定时期
	...
	unsigned int	  m_ulPremGeneralCardCount;	// 收集的卡牌数量
	...
	unsigned int	  m_ulPremIconStateID;		//	前提状态图标ID
