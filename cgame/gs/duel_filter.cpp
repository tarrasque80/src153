...
void 
pvp_duel_filter::TranslateEnchant(const XID & attacker,enchant_msg & msg)
{
	if(msg.ainfo.attacker == _target)
	{
		if(_mode)
...
void 
pvp_duel_filter::OnModify(int ctrlname, void * ctrlval, unsigned int ctrlen)
{
