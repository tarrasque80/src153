...
{ 
    ...
    { 
        ...
        pre_skills.push_back (std::pair < ID, int >(2731, 1)); 
        pre_skills.push_back (std::pair < ID, int >(2733, 1)); 
    ...
    { 
        static int array[10] = { 47437,47437,47437,47437,47437,47437,47437,47437,47437,47437 }; 
        return array[skill->GetLevel () - 1]; 
    } 
